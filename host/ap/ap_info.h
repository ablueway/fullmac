...
//station info
	...
	* in 802.11g BSS) */
	...
	bool sta_pkt_cln_timer;             //cleanup station packet in ps mode
    ...
    u32 channel_edcca_count[MAX_2G_CHANNEL_NUM];
    u32 channel_packet_count[MAX_2G_CHANNEL_NUM];
    u32 channel_5g_edcca_count[MAX_5G_CHANNEL_NUM];
    u32 channel_5g_packet_count[MAX_5G_CHANNEL_NUM];
    u8  acs_start;
    /* Beacon */
#if(AUTO_BEACON==0)
