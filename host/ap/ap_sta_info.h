...
typedef struct APStaInfo{
    ...
    u8 addr[ETH_ALEN];			//Mac Adderss ETHER_ADDR
	u16 aid; /* STA's unique AID (1 .. 2007) or 0 if not yet assigned */

	u32 _flags; /* Bitfield of WLAN_STA_* */
...
//---------------------------------------------
    ...
    struct list_q ps_tx_buf[IEEE80211_NUM_ACS];
...
//WMM
	...
	//bool wme;							//for power saving (APSD)
	u8 uapsd_queues;					//
	u8 max_sp;							//
...
static inline void set_sta_flag(APStaInfo_st *sta,
				u32 flag)
{
...
static inline void clear_sta_flag(APStaInfo_st *sta,
				  u32 flag)
{
...
static inline int test_sta_flag(APStaInfo_st *sta,
				u32 flag)
{
...
APStaInfo_st *APStaInfo_add(struct ApInfo *pApInfo, const u8 *addr);
