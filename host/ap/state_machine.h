...
void sm_ ## machine ## _ ## state ## _Enter(STATE_MACHINE_DATA *sm, \
	int global)
...
if (!global || sm->machine ## _state != machine ## _ ## state) { \
	sm->changed = TRUE; \
	LOG_DEBUGF(LOG_L2_AP, (STATE_MACHINE_DEBUG_PREFIX ": " #machine \
...
if (!global || sm->data ## _ ## state != machine ## _ ## _state) { \
	sm->changed = TRUE; \
	LOG_DEBUGF(LOG_L2_AP,( STATE_MACHINE_DEBUG_PREFIX ": " \
...
if (!global || sm->data ## _ ## state != machine ## _ ## _state) { \
	sm->changed = TRUE; \
	LOG_DEBUGF(LOG_L2_AP,( STATE_MACHINE_DEBUG_PREFIX ": " MACSTR " " \
		   #machine " entering state " #_state "\n\r", \
...
void sm_ ## machine ## _Step(STATE_MACHINE_DATA *sm)
