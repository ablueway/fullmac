...
/**
 * sha1_simple_vector - SHA-1 hash for data block vector
 * @data: Pointers to the data blocks
 * @block_num: Number of the data blocks
 * @mac: Buffer for the hash
 * Returns: 0 on success, -1 on failure
 */
int sha1_simple_vector(u8 data[][64], u32 block_num, u8 *mac);
#if 0
