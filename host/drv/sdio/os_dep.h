...
#define OS_WRAPPER_SDIO_HOST_LOCK(func)				        NULL //sdio_claim_host(NULL)
#define OS_WRAPPER_SDIO_HOST_UNLOCK(func)			        NULL //sdio_release_host(NULL)
#define OS_WRAPPER_SDIO_CMD52_RD(func, addr, pvalue)		    sdio_readb_cmd52(addr, pvalue)
#define OS_WRAPPER_SDIO_CMD52_WR(func, value, addr, ret)	sdio_writeb_cmd52(addr, value)
