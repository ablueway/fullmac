...
static s32 printchar(char **str, const char * const out_end, s32 c)
{
    if (str) {
...
static s32 __buf_prints (char **out, const char * const out_end, const char *string, s32 width)
{
...
static s32 __ser_prints (char **out, const char * const out_end, const char *string, s32 width)
{
	(void)out; 
	(void)out_end;
...
static s32 prints(char **out, const char * const out_end, const char *string, s32 width, s32 pad)
{
    s32 pc = 0;
    s32 len = strlen(string);
    char pad_buf[MAX_PAD_WIDTH];
    s32 (*__prints) (char **, const char * const out_end, const char *, s32) = out ? __buf_prints : __ser_prints;
...
s32 printstr ( char **out, const char * const out_end, const char *s, size_t size)
{
    s32 (*__prints) (char **, const char const *, const char *s, s32) = out ? __buf_prints : __ser_prints;
...
static s32 printi(char **out, const char * const out_end, s32 i, u32 b, s32 sg, s32 width, s32 pad, s32 letbase)
{
...
s32 print( char **out, const char * const out_end, const char *_format, va_list args )
{
    //lint --e{613}
