...
//HCI RX AGG
#define HCI_RX_AGGR_SIZE                   0x1b00								/* 6912 */
#define MAX_HCI_RX_AGGR_SIZE                (HCI_RX_AGGR_SIZE+MAX_FRAME_SIZE)   //AGGR_SIZE+MPDU = 9344
...
//===========================================================================    
    ...
    SSV6XXX_HOST_SOC_CMD_MAXID              = 10, // Not valid host command
//===========================================================================    
} ssv6xxx_host_cmd_id;
