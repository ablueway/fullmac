...
extern HOST_API_STATE _ssv6xxx_wifi_host_api_state(const bool mutexLock);
extern bool ssv6xxx_drv_detect_card(void);
extern int ssv_hal_pause_resuem_recovery_int(bool resume);



void ssv6xxx_wifi_ap_recover(u8 vif_idx)
{
#if (AP_MODE_ENABLE == 1)
    u16 operation_mode = host_to_le16(gDeviceInfo->APInfo->ht_op_mode);
    ...
    //ampdu tx
    _ssv6xxx_set_ampdu_param(AMPDU_TX_OPT_ENABLE,g_host_cfg.ampdu_tx_enable,FALSE);
    //ampdu rx
    _ssv6xxx_set_ampdu_param(AMPDU_RX_OPT_ENABLE,g_host_cfg.ampdu_rx_enable,FALSE);
    //ampdu rx aggr max
    _ssv6xxx_set_ampdu_param(AMPDU_RX_OPT_BUF_SIZE,g_host_cfg.ampdu_rx_buf_size,FALSE);
...
void ssv6xxx_wifi_sta_recover(u8 vif_idx)
{
	...
	/* TODO:aaron, no specific VIF ??? */
    //ampdu tx
    _ssv6xxx_set_ampdu_param(AMPDU_TX_OPT_ENABLE, g_host_cfg.ampdu_tx_enable, SSV6XXX_HWM_STA, FALSE);
    //ampdu rx
    _ssv6xxx_set_ampdu_param(AMPDU_RX_OPT_ENABLE, g_host_cfg.ampdu_rx_enable, SSV6XXX_HWM_STA, FALSE);
    //ampdu rx aggr max
    _ssv6xxx_set_ampdu_param(AMPDU_RX_OPT_BUF_SIZE, g_host_cfg.ampdu_rx_buf_size, SSV6XXX_HWM_STA, FALSE);
...
s32 ssv6xxx_wifi_get_recover_cnt(void)
{
...
extern u32 chip_interrupt;
extern bool reset_host_init(void);
...
void recovery_pause_resume(bool resume)
{
