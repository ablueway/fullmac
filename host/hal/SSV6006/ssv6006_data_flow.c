...
#if(SW_8023TO80211==1)
u32 g_ap_tx_data_flow=0;
u32 g_ap_tx_mgmt_flow=0;
u32 g_sta_tx_data_flow=0;
#endif


extern s32 _ssv6xxx_wifi_ioctl_Ext(u32 cmd_id, void *data, u32 len, bool blocking,const bool mutexLock);

inline void init_ap_tx_data_flow(void)
{
...
inline void init_ap_tx_mgmt_flow(void)
{
    unsigned int cmd_data[2];
...
inline void init_ap_tx_ctrl_flow(void)
{
    unsigned int cmd_data[2];
...
inline void init_ap_rx_data_flow(void)
{
...
inline void init_ap_rx_mgmt_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
inline void init_ap_rx_ctrl_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
inline void init_sta_tx_data_flow(void)
{
    unsigned int cmd_data[2];
...
inline void init_sta_tx_mgmt_flow(void)
{
    unsigned int cmd_data[2];
...
inline void init_sta_tx_ctrl_flow(void)
{
    unsigned int cmd_data[2];
...
inline void init_sta_rx_data_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
inline void init_sta_rx_mgmt_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
inline void init_sta_rx_ctrl_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
