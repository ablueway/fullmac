...
#define SSV6006_TURISMOC_PHY_TABLE_VER "8.00"
...
ssv_cabrio_reg ssv6006_turismoC_phy_setting[]={
    ...
    // AGC relock
    {0xccb0e098,0xd0102000}, // {rg_agc_relock_11b[31], rg_agc_relock_11gn[30], rg_agc_relock_en[28],
    ...
    // new pilot average
    {0xccb0f194,0x09360001}, // turn on new pilot average when HT_MF
...
#define DEFAULT_DPD_BBSCALE_2500    0x78
#define DEFAULT_DPD_BBSCALE_5100    0x80
#define DEFAULT_DPD_BBSCALE_5500    0x90    
#define DEFAULT_DPD_BBSCALE_5700    0x72
#define DEFAULT_DPD_BBSCALE_5900    0x72
