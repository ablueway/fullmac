...
static void _ssv6006_hal_efuse_power_switch(u32 on)
{
    u32 temp_value;
...
static u8 _ssv6006_hal_read_efuse(u8 *pbuf)
{
    u32 *pointer32, i;
    pointer32 = (u32 *)pbuf;

    _ssv6006_hal_efuse_power_switch(1);
    ...
    _ssv6006_hal_efuse_power_switch(0);
    return 1;
}

static u16 _ssv6006_hal_parser_efuse(u8 *pbuf, u8 *mac_addr)
{
    u8 *rtemp8,idx=0;
    u16 shift=0,i;
...
int ssv6006_hal_read_chip_id(void)
{
    u32 val;
    _ssv6006_hal_efuse_power_switch(1);
...
int ssv6006_hal_read_efuse_macaddr(u8* mcdr)
{
    ...
    _ssv6006_hal_read_efuse(efuse_mapping_table);

    _ssv6006_hal_parser_efuse(efuse_mapping_table,mcdr);
	#if 0
