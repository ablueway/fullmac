...
static inline void init_ap_tx_data_flow(void)
{
...
static inline void init_ap_tx_mgmt_flow(void)
{
    unsigned int cmd_data[2];
...
static inline void init_ap_tx_ctrl_flow(void)
{
    unsigned int cmd_data[2];
...
static inline void init_ap_rx_data_flow(void)
{
...
static inline void init_ap_rx_mgmt_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
static inline void init_ap_rx_ctrl_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
static inline void init_sta_tx_data_flow(void)
{
    unsigned int cmd_data[2];
...
static inline void init_sta_tx_mgmt_flow(void)
{
    unsigned int cmd_data[2];
...
static inline void init_sta_tx_ctrl_flow(void)
{
    unsigned int cmd_data[2];
...
static inline void init_sta_rx_data_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
static inline void init_sta_rx_mgmt_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
...
static inline void init_sta_rx_ctrl_flow(void)
{
    //We can trap into CPU many times, but the hw moudle that is before HCI must be CPU
    unsigned int cmd_data[2];
