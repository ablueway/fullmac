...
/* These two registes must be setting on ACS and SmartConfig mode*/
static const ssv_cabrio_reg temp_phy_setting[]={
    {0xce002008, 0x20400080},//CCA bit counts from 8-bit to 5-bit
    //{0xce004018, 0x28680000}, //Reduce the rx ability
};
#else
/* These two registes must be setting on ACS and SmartConfig mode*/
static const ssv_cabrio_reg temp_phy_setting[]={
    {0xce002008, 0x20230080},//CCA bit counts from 8-bit to 5-bit
...
#else
    {40,  0xce0020a0, 0x00161000, 0xce002008, 0x20400080},
    {45,  0xce0020a0, 0x00160800, 0xce002008, 0x20400080},
    {50,  0xce0020a0, 0x00160400, 0xce002008, 0x20400080},
    {60,  0xce0020a0, 0x00160200, 0xce002008, 0x20400080},
    {65,  0xce0020a0, 0x00160100, 0xce002008, 0x20400080},
    {70,  0xce0020a0, 0x00000000, 0xce002008, 0x20300080},
#endif
};
#endif
...
static const ssv_cabrio_reg phy_setting[]={
    ...
    {0xce000040, 0x01601400}, // modify EDCCA threshold
...
//    {0xce002008, 0x20230080},//extend CCA bit counts from 5-bit to 8-bit
...
#elif (CONFIG_CHIP_ID == SSV6030P)
    {0xce0071bc, 0x79806C72},//TX gain
#elif (CONFIG_CHIP_ID == SSV6052Q)
    {0xce0071bc, 0x80808080},//TX gain
#else
    ...
    */
    {0xce0043fc, 0x000104E5}, //0x000004e1},
...
static const u32 wifi_tx_gain[]={ // Mapping to 0xCE0071BC
    0x80808080,
    0x79807980,
    0x72797279,
    0x6C726C72,
...
# error "Please redefine SSV_INTERNAL_LDO!!"
...
#elif (CONFIG_CHIP_ID == SSV6052Q)
    {0xCE010014, 0x3DE684FF},
    {0xCE010018, 0x02457d79},
#endif
    ...
    {0xC0001D00, 0x5F000040},   // PMU registers //CIT-34 //CIT-67
    {0xC0001D04, 0x015D015D},

    {0xC0001D08, 0x00000000},   //default LDO
