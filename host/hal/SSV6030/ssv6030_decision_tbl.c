...
int ssv6030_hal_drop_probe_request(bool IsDrop)
{
    u32 val;
    if(IsDrop)
    {
...
int ssv6030_hal_ap_listen_neighborhood(bool en)
{
//Accept Beacon
//#define FRAME_ACCEPT 0
