/******************************************************
* drv_l2_usbd_uvc_descriptor_tbl.c
*
...
ALIGN4 INT8U USB_UVC_DeviceDescriptor[] =
{
...
ALIGN4 INT8U USB_UVC_Qualifier_Descriptor_TBL[]=
{
...
ALIGN4 INT8U USB_UVC_ConfigDescriptor[] =
{
/* Configuration 1 */
...
/* Class specific VS Frame Descriptor */
  ...
  DBVAL(WIDTH_640*HEIGHT_480*2),             // dwMaxVideoFrameBufferSize   max video/still frame size in bytes 640*480*2
 //30 frame set 
...
/* Standard VS Isochronous Video data Endpoint Descriptor */
  ...
  //B3VAL(96000),
  B3VAL(UAC_AUDIO_SAMPLE_RATE),           /* tSamFreq */
...
const ALIGN4 INT8U UVC_String0_Descriptor[] =
{
...
const ALIGN4 INT8U UVC_String1_Descriptor[] =
{
...
const ALIGN4 INT8U UVC_String2_Descriptor[] =
{
    /* Index 0x02: Product */
    0x1E,                                   // bLength                 36
    USB_STRING_DESCRIPTOR_TYPE,             // bDescriptorType          3 (STRING)
...
const ALIGN4 INT8U UVC_String3_Descriptor[] =
{
...
const ALIGN4 INT8U UVC_String4_Descriptor[] =
 {
    /* Index 0x04:  */
    0x20,                                   // bLength                 
    USB_STRING_DESCRIPTOR_TYPE,             // bDescriptorType          3 (STRING)
...
const ALIGN4 INT8U UVC_String5_Descriptor[] =
{
