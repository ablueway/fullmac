...
#define	C_MEDIA_V1_STANDARD_SD_CARD	 		1
#define	C_MEDIA_V2_STANDARD_SD_CARD	 		2
#define C_MEDIA_SDHC_CARD              		3
#define C_MEDIA_MMCHC_CARD					4
...
//extern INT8U drvl2_sdc_card_protect_get(INT32S SD_DEVICE_NUM);			// Return 0 when writing to SD card is allowed
//extern void drvl2_sdc_card_protect_set(INT32S SD_DEVICE_NUM, INT8U value);	// value: 0=allow to write SD card. Other values=Not allow to write SD card
...
extern INT16S drvl2_sdc_live_response(void);
	...
	extern INT16S drvl2_sd1_live_response(void);
#endif
