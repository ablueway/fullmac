...
INT32S image_scale(IMAGE_SCALE_STRUCT *img_scale_struct)
{
	...
	drv_l1_scaler_input_A_addr_set(C_USE_SCALER_NUMBER,(INT32U)img_scale_struct->input_buf1, NULL, NULL);
	...
	drv_l1_scaler_output_addr_set(C_USE_SCALER_NUMBER,(INT32U) img_scale_struct->output_buf1, NULL, NULL);
