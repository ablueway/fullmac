...
#define __GPLIB_CFG_H__
    ...
    // console
	#define GPLIB_CONSOLE_EN				0
    
    // Memory management module
    #define GPLIB_MEMORY_MANAGEMENT_EN		1
	#define C_MM_IRAM_LINK_NUM				20
	#define C_MM_16BYTE_NUM					32
    #define C_MM_64BYTE_NUM                 64
    #define C_MM_256BYTE_NUM                48
    #define C_MM_1024BYTE_NUM               12
    #define C_MM_4096BYTE_NUM               10
	...
	#define _FS_DEFINE_
		...
		#define SD_EN             1
		#define CFC_EN            0
		#define NAND_APP_EN		  0 // To enable nand app area, and read only access through FS and MSDC interface 
		...
		#define NAND3_EN          0 // This should 0 when nandrom.
		#define USB_NUM           0
		#define NOR_EN            0
		#define XD_EN             0
		#define RAMDISK_EN        0
