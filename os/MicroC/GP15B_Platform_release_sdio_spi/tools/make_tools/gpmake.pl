...
#-----------------------------Begin - 2013/10/28 - Added by Eric --------------------------------------------------------------------------
#reason: to let GP10 & GP19 or other platform modules compile dynamically just with ini file.
#-----------------------------------------------------------------------------------------------------------------------------------------------------------
   $Widx++;
  @WriteBuf[$Widx] = sprintf ("NAND_DRIVER_L1 = %s\n",ReadConfigIni("Project","NAND_DRIVER_L1"));  
  $Widx++;
  @WriteBuf[$Widx] = sprintf ("NAND_DRIVER_L2 = %s\n",ReadConfigIni("Project","NAND_DRIVER_L2")); 
#-----------------------------End - 2013/10/28 - Added by Eric --------------------------------------------------------------------------
